### Projede repository pattern kullanılmıştır. Repository pattern bakım kolaylığı sağlar, esnektir. Yeni gelecek modüller veya istenilen değişiklikleri kolayca entegre edebilmeyi sağlar.
